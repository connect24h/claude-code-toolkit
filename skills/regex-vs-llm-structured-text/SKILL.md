...
description: Decision framework for choosing between regex and LLM when parsing structured text — start with regex, add LLM only for low-confidence edge cases. Use when deciding between regex and LLM for text parsing, or building hybrid extraction pipelines.
origin: ECC
