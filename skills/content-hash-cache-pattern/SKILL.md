...
description: Cache expensive file processing results using SHA-256 content hashes — path-independent, auto-invalidating, with service layer separation. Use when implementing file processing caches, content-addressed storage, or avoiding redundant reprocessing.
origin: ECC
