...
`$HOME/iketomo_ch/config/channels.json` でチャンネルを管理。
...
出力先: $HOME/[channel]/summaries/YYYYMMDD_[VIDEO_ID]_summary.md
```
...
### 全動画取得
```bash
$HOME/iketomo_ch/scripts/fetch_year.sh 2025
```

### 特定シリーズのみ取得（注目AIニュースなど）
```bash
$HOME/iketomo_ch/scripts/fetch_year.sh 2025 "https://www.youtube.com/@iketomo-ch" "注目AIニュース"
```
